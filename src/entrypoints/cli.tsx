...
// Backward-compatible env var aliases: if LOUKANIKODE_* is not set but CLAUDE_CODE_* is, copy it over
(function setupEnvAliases() {
  const aliases: Array<[string, string]> = [
    ['LOUKANIKODE_USE_LLAMA', 'CLAUDE_CODE_USE_LLAMA'],
    ['LOUKANIKODE_USE_BEDROCK', 'CLAUDE_CODE_USE_BEDROCK'],
    ['LOUKANIKODE_USE_VERTEX', 'CLAUDE_CODE_USE_VERTEX'],
    ['LOUKANIKODE_USE_FOUNDRY', 'CLAUDE_CODE_USE_FOUNDRY'],
    ['LOUKANIKODE_USE_OPENAI', 'CLAUDE_CODE_USE_OPENAI'],
    ['LOUKANIKODE_ATTRIBUTION_HEADER', 'CLAUDE_CODE_ATTRIBUTION_HEADER'],
    ['LOUKANIKODE_ENABLE_TELEMETRY', 'CLAUDE_CODE_ENABLE_TELEMETRY'],
    ['LOUKANIKODE_DISABLE_NONESSENTIAL_TRAFFIC', 'CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC'],
    ['LOUKANIKODE_SIMPLE', 'CLAUDE_CODE_SIMPLE'],
    ['LOUKANIKODE_ENTRYPOINT', 'CLAUDE_CODE_ENTRYPOINT'],
    ['LOUKANIKODE_CONFIG_DIR', 'CLAUDE_CONFIG_DIR'],
    ['LOUKANIKODE_REMOTE', 'CLAUDE_CODE_REMOTE'],
    ['LOUKANIKODE_REMOTE_SESSION_ID', 'CLAUDE_CODE_REMOTE_SESSION_ID'],
    ['LOUKANIKODE_OAUTH_TOKEN', 'CLAUDE_CODE_OAUTH_TOKEN'],
  ];
...
if (process.env.LOUKANIKODE_REMOTE === 'true') {
...
// eslint-disable-next-line custom-rules/no-top-level-side-effects, custom-rules/no-process-env-top-level
if (feature('ABLATION_BASELINE') && process.env.LOUKANIKODE_ABLATION_BASELINE) {
  for (const k of ['LOUKANIKODE_SIMPLE', 'LOUKANIKODE_DISABLE_THINKING', 'DISABLE_INTERLEAVED_THINKING', 'DISABLE_COMPACT', 'DISABLE_AUTO_COMPACT', 'LOUKANIKODE_DISABLE_AUTO_MEMORY', 'LOUKANIKODE_DISABLE_BACKGROUND_TASKS']) {
    // eslint-disable-next-line custom-rules/no-top-level-side-effects, custom-rules/no-process-env-top-level
    process.env[k] ??= '1';
  }
}
