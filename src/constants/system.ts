...
import { isLlamaModeEnabled } from './localLlama.js'
...
function isAttributionHeaderEnabled(): boolean {
  ...
  if (isEnvDefinedFalsy(process.env.LOUKANIKODE_ATTRIBUTION_HEADER)) {
    return false
  }
...
export function getAttributionHeader(fingerprint: string): string {
  ...
  const entrypoint = process.env.LOUKANIKODE_ENTRYPOINT ?? 'unknown'
