 ...
 * and from ~/.loukanikode/output-styles directory and converts them to output styles.
 *
 ...
 * - User ~/.loukanikode/output-styles/*.md -> user styles (overridden by project styles)
 *
