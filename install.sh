...
echo ""
printf "  ${BOLD}Configure your local model:${RESET}\n"
printf "    ${CYAN}export LLAMA_CPP_SERVER=http://localhost:8080/v1${RESET}\n"
printf "    ${CYAN}export LOUKANIKODE_USE_LLAMA=1${RESET}\n"
echo ""
